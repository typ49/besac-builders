...
tp @s[tag=possede_un_coffre,predicate=besac_builders:dans_monde_survie] @e[type=area_effect_cloud,tag=spawn_besancon,limit=1]
tp @s[predicate=besac_builders:dans_monde_creatif] @e[type=area_effect_cloud,tag=spawn_besancon,limit=1]
tp @s[tag=besac_admin] @e[type=area_effect_cloud,tag=spawn_besancon,limit=1]
